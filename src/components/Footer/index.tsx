    ...
    <>
      ...
      >
        <div className="container">
          <div className="-mx-4 ">
            <div className="w-full px-4 md:w-full flex flex-col md:flex-row justify-around">
              <div className="mb-12 lg:mb-16 md:order-2">
                <p className="font-bold text-xl mb-8 inline-block">SOCIAL</p>
              ...
              <div className="mb-12 lg:mb-16 md:order-1">
            ...
            {/* <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12 space-x-0">
